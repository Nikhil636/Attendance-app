...
Welcome to [Nikhil636/Attendance-app](https://github.com/Nikhil636/Attendance-app). Before sending your pull requests, make sure that you **read the whole
...
* Step 1: Fork the repo and Go to your Git terminal and clone it on your machine.
    ```
    git clone https://github.com/<your_github_username>/Attendance-app
    ```
* Step 2: Add an upstream link to the main branch in your cloned repo
    ```
    git remote add upstream https://github.com/Nikhil636/Attendance-app.git
    ```
